...
export const ScraperService = {
  ...
  scrapeAmazonLaptops: async () => {
    try {
      ...
      if (menuBtn) {
        ...
        await delay(3000);
        let mobileBtnn = await page.waitForSelector(
          `#hmenu-content > ul:nth-child(8) > li:nth-child(17) > a`,
          {
            visible: true,
            waitUntil: "load",
            waitUntil: "domcontentloaded",
        ...
        const value = await mobileBtnn.evaluate((el) => el.textContent);
        await mobileBtnn.click();
        await page.waitForNavigation({
          waitUntil: "domcontentloaded",
        });
  ...
  scrapeAmazonTablets: async () => {
    try {
      ...
      if (menuBtn) {
        ...
        await delay(3000);
        let mobileBtnn = await page.waitForSelector(
          `#hmenu-content > ul:nth-child(8) > li:nth-child(9) > a`,
          {
            visible: true,
            waitUntil: "load",
            waitUntil: "domcontentloaded",
  ...
  scrapeAmazonTelevision: async () => {
    try {
      ...
      if (menuBtn) {
        ...
        await delay(3000);
        let mobileBtnn = await page.waitForSelector(
          `#hmenu-content > ul:nth-child(9) > li:nth-child(3) > a`,
          {
            visible: true,
            waitUntil: "load",
            waitUntil: "domcontentloaded",
  ...
  scrapeAmazonAC: async () => {
    try {
      ...
      if (menuBtn) {
        ...
        await delay(3000);
        let mobileBtnn = await page.waitForSelector(
          `#hmenu-content > ul:nth-child(9) > li:nth-child(17) > a`,
          {
            visible: true,
            waitUntil: "load",
            waitUntil: "domcontentloaded",
  ...
  scrapeAmazonWashingMachines: async () => {
    try {
      async function delay(time) {
        return new Promise(function (resolve) {
          setTimeout(resolve, time);
      ...
      if (menuBtn) {
        ...
        await delay(3000);
        let mobileBtnn = await page.waitForSelector(
          `#hmenu-content > ul:nth-child(9) > li:nth-child(19) > a`,
          {
            visible: true,
            waitUntil: "load",
            waitUntil: "domcontentloaded",
